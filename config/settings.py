...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'emirhansenturk574000@gmail.com' # Kendi Gmail adresin
EMAIL_HOST_PASSWORD = 'bpshjraxprzfsncc' # Google'ın verdiği 16 haneli Uygulama Şifresi (Boşluksuz)
